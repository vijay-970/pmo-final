...
class Router{
   ...
   login(app,db){
       app.post('/login',(req,res)=>{
           ...
           const decrptpassword = cryptr.decrypt(password);
           const decrptusername = cryptr.decrypt(username);
        db.query('Select * from users_t where user_name= ?',[decrptusername],(err,data,fields) =>
           {
               console.log(data[0].PASSWORD);
                bcrypt.compare(decrptpassword,data[0].PASSWORD,(bcrypterr,verified)=>{
                    if(verified) {
...
getUsers(app, db) {
    app.get('/get-users/', (req, res) => {
        const query = 'select user_name  from users_t where user_name !="sumit";';
        db.query(query,req.params.ID, (err, rows, field) => {
            if (!err) {
                console.log(rows);
                res.json(rows);
          ...
          db.query(queryPMRole, [PROJECT_NAME], (err, rows, field) => {
            ...
            db.query(projectssql, [PROJECT_NAME], (err, rows, field) => {
                if (!err) {
				   ...
				   '(8,'+proj_id+',1,"NO",null,sysdate(),"admin",sysdate(),"admin");';
                  // '(7,'+proj_id+',1,"NO",null,sysdate(),"admin",sysdate(),"admin");';
...
'('+proj_id+',3,27,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',4,28,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',4,29,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',4,30,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',4,31,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',4,32,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,33,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,34,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,35,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,36,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,37,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,38,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,39,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,40,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,41,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,42,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,43,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,44,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,45,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,46,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,47,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,48,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,49,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',8,50,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,51,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,52,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,53,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,54,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,55,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,56,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin"),'+
'('+proj_id+',5,57,1,"NO",null,null,null,null,sysdate(),"admin",sysdate(),"admin");';
