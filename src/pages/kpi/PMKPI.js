    ...
    return (
     ...
     // <Button onClick={handleSave}>Save</Button>
      <div className="kpiTable">
        <h2>Project: {projectName[0]}</h2>
        <button style={{backgroundColor: "#0095b6", color: "white", fontSize: "16px", cursor: "pointer"}} type="submit" onClick={handleSave}>     
  ...
  <path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1H2z"/>
        ...
        <TableContainer >
          <Table>
            <TableHead>
              <TableRow>
                <StyledTableCell  style={{ width: 100, textAlign: 'left' }}><b>Milestone</b></StyledTableCell>
                <StyledTableCell  style={{ width: 220, textAlign: 'left' }}><b>Parameters</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left' }}><b>Max Points</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left' }}><b>PM Points</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left' }}><b>PMO Points</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left'}}><b>Weight </b>  </StyledTableCell>
                <StyledTableCell style={{ width: 20, textAlign: 'left'}}><b> Score</b></StyledTableCell>
                <StyledTableCell  style={{ width: 200, textAlign: 'left' }} ><b>PM Notes</b></StyledTableCell>
                <StyledTableCell  style={{ width: 100, textAlign: 'left' }}> <b>PMO Notes</b></StyledTableCell>
              </TableRow>
            </TableHead>
                      ...
                      <TableBody>
                        {kpi.filter((row) => row.MILESTONE === rows.MILESTONE && row.CYCLE_ID===rows.CYCLE_ID ).map((row, i, arr) => (
                            <TableRow key={row.PARAMETER_NAME}>
                              ...
                              <StyledTableCell component="td" style={{ width: 300,textAlign:'left'}}>
                                {row.PARAMETER_NAME}</StyledTableCell>
                              <StyledTableCell component="td" style={{ width: 80,textAlign: 'left' }}>
                              ...
                              {i === 0 ? (
                                <StyledTableCell component="td" rowSpan={arr.length} style={{  width: 50, textAlign: 'left', borderBottom: 'none'}}>
                                  {rows.KPI_WEIGHT}
                                </StyledTableCell>
                              ) : null}
                              {i === 0 ? (
                     ...
                     ((kpi.filter( (row) => row.MILESTONE === rows.MILESTONE && row.CYCLE_ID===rows.CYCLE_ID)
                            ...
                            .map((row) => row.MAX_SCORE).reduce(reducer) )                            
                              * rows.KPI_WEIGHT}
                              ...
                              <StyledTableCell style={{width: 250,textAlign: 'left',borderBottom: 'none'}}>
                                {!row.editPMNotes && (
                                  <>
                                  <a style={{display: "inline-block",width:250,maxWidth:250,wordBreak:"break-all"}}  href={row.KPI_PM_NOTES} target="_blank" title={row.KPI_PM_NOTES}>LINK</a>
