      ...
      <div className="kpiTable">
        ...
        <TableContainer >
          <Table>
            <TableHead>
              <TableRow>
                <StyledTableCell  style={{ width: 100, textAlign: 'left' }}><b>Category</b></StyledTableCell>
                <StyledTableCell  style={{ width: 220, textAlign: 'left' }}><b>Details</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left' }}><b>Max Points</b></StyledTableCell>
                <StyledTableCell  style={{ width: 20, textAlign: 'left' }}><b>SA Points</b></StyledTableCell>
                ...
                <StyledTableCell  style={{ width: 200, textAlign: 'left' }} ><b>SA Notes</b></StyledTableCell>
                        ...
                        {kpi.filter((row) => row.kpi_desc === rows.kpi_desc).map((row, i, arr) => (
                            <TableRow key={row.kpi_detail_task_name}>
                              ...
                              >
                                {!row.editPMNotes && (
                                  <>
                                  <a style={{display: "inline-block",width:250,maxWidth:250,wordBreak:"break-all"}} href={row.NOTES} target="_blank">{row.NOTES}</a>
                                    {projectPMO[0] === 'N' && (
                                      <IconButton
